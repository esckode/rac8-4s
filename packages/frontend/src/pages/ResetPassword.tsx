        ...
        {attemptsRemaining !== null && attemptsRemaining > 0 && attemptsRemaining <= 2 && (
          <div
            style={{
              ...
              gap: 10,
              padding: '12px 14px',
              background: 'var(--auth-warning-wash)',
          ...
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="var(--auth-warning)" style={{ flexShrink: 0, marginTop: 2 }}>
          ...
          <div>
            ...
            <input
              ...
              style={{
                ...
                height: 52,
                padding: '0 14px',
                background: errors.code ? 'var(--auth-danger-wash)' : 'var(--auth-glass-bg)',
                border: errors.code ? '1.5px solid var(--auth-danger)' : '1px solid var(--auth-glass-border)',
                borderRadius: 14,
                boxShadow: errors.code ? '0 0 0 4px var(--auth-danger-ring)' : 'none',
                fontSize: 15,
                fontFamily: 'var(--font-ui)',
                color: formData.code ? 'var(--auth-glass-text)' : 'var(--auth-glass-placeholder)',
                letterSpacing: '-0.005em',
                fontWeight: 500,
                transition: 'all .15s ease',
                boxSizing: 'border-box',
          ...
          <div>
            ...
            >
              ...
              {formData.password && formData.confirmPassword && formData.confirmPassword === formData.password && !errors.confirmPassword && (
                <span style={{ color: 'var(--court-400)', textTransform: 'none', fontWeight: 500 }}>✓ Matches</span>
              )}
            </label>
            <div
              style={{
                ...
                height: 52,
                padding: '0 14px',
                background: errors.confirmPassword ? 'var(--auth-danger-wash)' : 'var(--auth-glass-bg)',
                border: errors.confirmPassword ? '1.5px solid var(--auth-danger)' : '1px solid var(--auth-glass-border)',
                borderRadius: 14,
                boxShadow: errors.confirmPassword ? '0 0 0 4px var(--auth-danger-ring)' : 'none',
                transition: 'all .15s ease',
              }}
            >
              <input
                ...
                style={{
                  ...
                  fontSize: 15,
                  fontFamily: 'var(--font-ui)',
                  color: formData.confirmPassword ? 'var(--auth-glass-text)' : 'var(--auth-glass-placeholder)',
                  letterSpacing: '-0.005em',
                  fontWeight: 500,
                  border: 'none',
                  background: 'transparent',
