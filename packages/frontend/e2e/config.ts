...
export const SELECTORS = {
  ...
  POLL_CLOSE_WINDOW: '[data-testid="poll-close-window"]',
  POLL_CONFIG_FORM: '[data-testid="poll-config-form"]',
  POLL_AUTO_CLOSE_INPUT: '[data-testid="poll-auto-close-input"]',
  POLL_AUTO_LAUNCH_TOGGLE: '[data-testid="poll-auto-launch-toggle"]',
  POLL_MIN_PLAYERS_INPUT: '[data-testid="poll-min-players-input"]',
  POLL_LAUNCH_FORMAT_SELECT: '[data-testid="poll-launch-format-select"]',
  LAUNCH_CONFIRM_SHEET: '[data-testid="launch-confirm-sheet"]',
  LAUNCH_FORMAT_SELECT: '[data-testid="launch-format-select"]',
  LAUNCH_CONFIRM_BUTTON: '[data-testid="launch-confirm-button"]',
  LAUNCH_CANCEL_BUTTON: '[data-testid="launch-cancel-button"]',
  TOURNAMENT_DEEP_LINK: '[data-testid="tournament-deep-link"]',
  GROUP_TAB_LEADERBOARD: '[data-testid="group-tab-leaderboard"]',
  MIXER_STATE_PANEL: '[data-testid="mixer-state-panel"]',
  SITTING_OUT_LIST: '[data-testid="sitting-out-list"]',
  MIXER_ALL_ACTIVE: '[data-testid="mixer-all-active"]',
  SCORED_BY: '[data-testid="scored-by"]',
