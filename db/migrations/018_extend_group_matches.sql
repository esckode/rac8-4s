-- Phase 1.3: Extend group_matches with team columns
-- Makes group_matches polymorphic: supports singles (player1/player2) OR doubles (team1/team2)
...
-- Allows walkovers where both players are NULL and both teams are NULL
...
BEGIN
  ...
  SELECT EXISTS(
    ...
    AND constraint_name = 'check_match_type'
...
CREATE INDEX IF NOT EXISTS idx_group_matches_team1 ON public.group_matches(team1_id);
CREATE INDEX IF NOT EXISTS idx_group_matches_team2 ON public.group_matches(team2_id);
